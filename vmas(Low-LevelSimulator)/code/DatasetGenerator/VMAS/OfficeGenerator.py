...
class OfficeGenerator(VMASGenerator):
    ...
    class Expert():
        ...
        def initMap(self):
            boxes = []
            corners = []
            with open(os.path.dirname(os.path.abspath(__file__))+"/plans/office_map.txt", "r") as f:
                text = f.read()
        ...
        def load_hl_plan(self):
            plan = []
            with open(os.path.dirname(os.path.abspath(__file__))+"/plans/office.txt", "r") as f:
                text = f.read()
        ...
        class PotentialFieldsAgent():
            ...
            def forward(self, pos):
                ...
                forces = 5 * attraction + 0.15*repulsion_agents + 0.01*repulsion_wall
